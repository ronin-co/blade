...
This frontmatter is automatically converted to:
...
To demonstrate the power of MDX, let's create a simple documentation website. You can see a real-world example in the [Blade documentation repository](https://github.com/ronin-co/blade/tree/main/docs).
...
For more examples and advanced usage patterns, explore the [Blade documentation repository](https://github.com/ronin-co/blade/tree/main/docs) and [examples directory](https://github.com/ronin-co/blade/tree/main/examples).
