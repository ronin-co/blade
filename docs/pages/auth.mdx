...
import { addSession, getSession, removeSession, afterAddSession } from "blade/server/auth";
...
show some kind of a "Contratulation" message, with a button for continuing to the
