...
emails, you can provide the following function call in the respective trigger file:

```ts
// triggers/account.ts

import { setAuthConfig } from 'blade/auth/utils';
...
entered was wrong), you can let them cancel the signup and thereby have their unverified
account cleaned up.
