...
In the “Settings” section of every model on the dashboard, both the Slug and the Plural Slug must be provided in [camel case](https://en.wikipedia.org/wiki/Camel_case), in order to make it easy to re-use the slugs in Blade queries.
