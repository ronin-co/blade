        ...
        ([effectName, effectFunction]) => [
          ...
          (...args: Parameters<BeforeGetEffect>) => {
            ...
            if (typeof headless === 'boolean') {
              ...
              // an effect (`headless: true`), we don't need to perform further checks.
              //
              // Otherwise, if the client insists that the query was not generated by an
              // effect (`headless: false`), we need to check if the query is headless
              // based on Blade's own query primitives.
              if (oldOptions.headless === true) {
